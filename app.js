...
server.use('/mydrive',express.static(path.join(__dirname,'static','app')))
server.use('/',express.static(path.join(__dirname,'static','login')))
...
server.get('/mydrive',(req,res)=>{
    res.sendFile(path.join(__dirname,'static','app','appindex.html'))
})
